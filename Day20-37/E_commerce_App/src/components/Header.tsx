    ...
    <header className="header">
      <div className="container">
        ...
        {token && user && (
          ...
          <button className="Itembutton" onClick={() => navigate('/dashboard')}>All Products</button>
        ...
        <nav className="nav">
          {token && user ? (
            <div className="user-info">
             {
               user.role === "admin" ? ( <div>
               <button onClick={handleMoveToMyItems}>My Products</button>
