  ...
  return (
    <div className="product-detail-container">
      ...
      {product?.owner && (
        ...
        <p>
          Uploaded by: <strong>{product.owner.name}</strong>
        </p>
       {product.owner.email && (
         <p>
         Contact: <a href={`mailto:${product.owner.email}`}>{product.owner.email}</a>
        </p>
      )}
  </div>
)}
        ...
        <p className="brand">Category: <strong>{product.category}</strong></p>
        ...
        <div className="action-buttons">
          {user?.role === "admin" ? (
            <div className="admin-controls">
              <button className="edit-button" onClick={() => handleEdit(product)}>Edit Content</button>
              <button className="delete-button" onClick={() => setShowDeletePopUp(true)}>Delete Content</button>
            </div>
          ) : (
        ...
        <div className="product-feedback-section">
          ...
          <form onSubmit={handleFeedbackSubmit}>
            <textarea
              placeholder={user?.role === "admin" ? " Write here..." : "Write your experience here..."}
              value={feedback}
